        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2">
            {!userInfo ? (<>
				...
				<Link
                to="/login"
                className="text-white bg-blue-500 rounded-lg px-4 py-2 hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-300"
              >
                Login
              </Link>
              ...
              <>
                <button className="text-white bg-blue-500 rounded-lg px-4 py-2 hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-300">
                ...
                <button
                  ...
                  className="text-white bg-blue-500 rounded-lg px-4 py-2 ml-2 hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-300"
                >
                  Logout
                </button>
              </>
            ...
            <button
              ...
              type="button"
              className="md:hidden px-2 py-1 rounded-lg border-2 border-gray-600 bg-blue-500 hover:text-white focus:outline-none focus:ring focus:ring-blue-300"
